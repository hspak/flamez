...
limit — aim for 100, use common sense. Keep short function calls and signatures
on one line when they fit. Literals with more than two items go one per line,
...
26. Run `zig fmt`, keep short calls and signatures compact, wrap multi-item literals,
    and aim for 100 columns with the stated exceptions.
